        ...
        <>
            <div className="flex bg-black h-14">
                <ul className='flex'>
                    ...
                    <MapPinIcon style={{ color: 'white', width: '1.7rem', marginLeft: '0.5rem' }} />
                    ...
                    <button style={{ backgroundColor: 'black', width: '2.1rem', height: '2.2rem', paddingLeft: '0.3rem', marginTop: '.8rem', borderRadius: '.2rem',marginLeft:'.2rem'}}><LanguageIcon style={{ color: 'white', width: '1.5rem' }} /></button>
